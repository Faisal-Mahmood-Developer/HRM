        ...
        const fetchEmployees = async () => {
            try {
                ...
                const hr = data.filter(
                    (emp) => emp.department?.trim().toLowerCase() === "qa department"
                );
                setHrEmployees(hr);
            } catch (err) {
        ...
        <div className="container mt-5">
            <div className="card shadow">
                <div className="card-header bg-primary text-white">
                    <h5 className="mb-0 text-center">Quality Assurance Department</h5>
                </div>
                <div className="card-body table-responsive">
                    {hrEmployees.length === 0 ? (
                        <p className="text-center">No employees found in the Quality Assurance Department.</p>
                    ) : (
