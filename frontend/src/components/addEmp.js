...
const AddEmp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/api/employees/sendData', {
        method: 'POST',
        body: data
      });
      ...
      if (response.ok) {
        ...
        setResume(null);
        setCnicCopy(null);
        setAcademicDocs(null);
        setExperienceLetters(null);
        setContractLetter(null);
      } else {
        setAlertMsg(result.message || "Failed to add employee.");
        setAlertType("danger");
      }
    } catch (error) {
      console.error('Upload failed:', error);
      setAlertMsg("Failed to submit employee data.");
      setAlertType("danger");
    }
  };
  return (
          ...
          <form onSubmit={handleSubmit} encType="multipart/form-data">
            <div className="row g-3">
              ...
              <div className="col-md-4"><label className="form-label">Name</label>
                <input type="text" className="form-control" name="name" value={formData.name} onChange={handleChange} required placeholder="Enter full name" />
              </div>
              <div className="col-md-4"><label className="form-label">Father Name</label>
                <input type="text" className="form-control" name="fatherName" value={formData.fatherName} onChange={handleChange} required placeholder="Enter father's name" />
              </div>
              <div className="col-md-4"><label className="form-label">Employee ID</label>
                <input type="text" className="form-control" name="empId" value={formData.empId} onChange={handleChange} required placeholder="Enter employee ID" />
              </div>
              <div className="col-md-4"><label className="form-label">Designation</label>
                <input type="text" className="form-control" name="designation" value={formData.designation} onChange={handleChange} required placeholder="Enter designation" />
              </div>
              ...
              <div className="col-md-4"><label className="form-label">Contact Number</label>
                <input type="text" className="form-control" name="contact" value={formData.contact} onChange={handleChange} required placeholder="Enter contact number" />
              </div>
              <div className="col-md-4"><label className="form-label">ICE Number</label>
                <input type="text" className="form-control" name="ice" value={formData.ice} onChange={handleChange} required placeholder="Enter emergency contact number" />
              </div>
              <div className="col-md-4"><label className="form-label">ID Number</label>
                <input type="text" className="form-control" name="idNumber" value={formData.idNumber} onChange={handleChange} required placeholder="Enter CNIC or ID number" />
              </div>
              <div className="col-md-4"><label className="form-label">City</label>
                <input type="text" className="form-control" name="city" value={formData.city} onChange={handleChange} required placeholder="Enter city" />
              </div>
              <div className="col-md-4"><label className="form-label">Address</label>
                <input type="text" className="form-control" name="address" value={formData.address} onChange={handleChange} required placeholder="Enter full address" />
              </div>
              <div className="col-md-4"><label className="form-label">Linkedin</label>
                <input type="text" className="form-control" name="linkedin" value={formData.status} onChange={handleChange} required placeholder="Enter LinkedIn profile URL" />
              </div>
              <div className="col-md-4"><label className="form-label">Blood Group</label>
                <input type="text" className="form-control" name="bloodGroup" value={formData.bloodGroup} onChange={handleChange} required placeholder="Enter blood group (e.g. A+, O-)" />
              </div>
              ...
              <div className="col-md-4"><label className="form-label">Nationality</label>
                <input type="text" className="form-control" name="nationality" value={formData.nationality} onChange={handleChange} required placeholder="Enter nationality" />
              </div>
              ...
              <div className="col-md-4"><label className="form-label">Upload Image</label>
                <input type="file" className="form-control" onChange={handleFileChange(setFile)} accept="image/*" required placeholder="Upload profile picture" />
              </div>
              ...
              <div className="col-md-4"><label className="form-label">Emergency Contact Person</label>
                <input type="text" className="form-control" name="emergencyContactName" value={formData.emergencyContactName} onChange={handleChange} required placeholder="Enter emergency contact name" />
              </div>
              ...
              <div className="col-md-4"><label className="form-label">Upload Resume</label>
                <input type="file" className="form-control" onChange={handleFileChange(setResume)} placeholder="Upload resume file" />
              </div>
              <div className="col-md-4"><label className="form-label">Upload CNIC Copy</label>
                <input type="file" className="form-control" onChange={handleFileChange(setCnicCopy)} placeholder="Upload CNIC copy" />
              </div>
              <div className="col-md-4"><label className="form-label">Upload Academic Documents</label>
                <input type="file" className="form-control" onChange={handleFileChange(setAcademicDocs)} placeholder="Upload academic certificates" />
              </div>
              <div className="col-md-4"><label className="form-label">Upload Experience Letters</label>
                <input type="file" className="form-control" onChange={handleFileChange(setExperienceLetters)} placeholder="Upload experience letters" />
              </div>
              <div className="col-md-4"><label className="form-label">Upload Contract/Offer Letter</label>
                <input type="file" className="form-control" onChange={handleFileChange(setContractLetter)} placeholder="Upload contract/offer letter" />
              </div>
            </div>
